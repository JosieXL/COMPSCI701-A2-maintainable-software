...
/**
 * This class is the Move class, contains mainly moveStepP1RoundReturnFinalMoveIndex 
 * method and moveStepP2RoundReturnFinalMoveIndex method to do the moving 
 * in the back of the kalah board.
 * The methods return an integer lastIndexMove, a 2d int[][] numberArray.
...
public class Move {
    ...
    public returnIntWithIntArr moveStepP2RoundReturnFinalMoveIndex(IO io, int[][] numberArray, int inputInt, boolean bmf) {
        ...
        if ((numberArray[2][0] == 0) && (bmf == true)) {
            numberArray = specialCaseKalahRobot(io, lastMoveIndex, numberArray);
    ...
    private int[][] specialCaseKalahP1(IO io, int lastMoveIndex, int[][] numberArray, int collectSeedFromHouse) {
    ...
    private int[][] specialCaseKalahP2(IO io, int lastMoveIndex, int[][] numberArray, int collectSeedFromHouse) {
        KalahBoard kalahBoard = new KalahBoard();
    ...
    private int[][] specialCaseKalahRobot(IO io, int lastMoveIndex, int[][] numberArray) {
        //KalahBoard kalahBoard = new KalahBoard();
        if ((lastMoveIndex != 6) && (lastMoveIndex < numberArray[1].length) && (numberArray[1][lastMoveIndex] == 1)) {
            if (numberArray[0][numberArray[0].length-2-lastMoveIndex] > 0) {
                int p2Seed = numberArray[1][lastMoveIndex];
